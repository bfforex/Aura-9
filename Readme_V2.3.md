...
**Version:** 2.3 | **Status:** Active Development Blueprint | **Classification:** Internal Reference
...
| **Mission Manifest** | Structured YAML task plan generated by the Pre-Processor, versioned at `manifest_version: 2.3` |
...
*Aura-9 Specification — Version 2.3 | Canonical Development Blueprint | All 21 v2.2 audit findings resolved.*
